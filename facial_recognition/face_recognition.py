"""
Facial Recognition Module using MTCNN for face detection and ResNet50 for face recognition.

This module provides a class for facial recognition operations including face detection,
embedding generation, face registration, and face recognition. It uses MTCNN for face detection
and ResNet50 for generating face embeddings.
...
class FacialRecognition:
    """
    A class for facial recognition using MTCNN for face detection and ResNet50 for face embedding.
    ...
    def get_embedding(self, face_array):
        """
        Generate embedding for a face using ResNet50.
